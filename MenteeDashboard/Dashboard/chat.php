  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="indexmenteedash.php">
...
if (isset($_GET['topicid']) && isset($_GET['userid']) && isset($_GET['groupid'])) {
  ...
  if($userRow==null){
    echo "Start entering your chat!!";
    $chatactivator="chat is not active yet";
    echo $chatactivator;
...
if (isset($_GET['topicid']) && isset($_GET['userid'])) {
  ...
  $checkLvl = "SELECT c.MENTORID FROM discuss a JOIN user b JOIN assign c WHERE MEMBERID != '$userid' AND TOPICID='$topicid' AND b.USERID=a.MEMBERID AND a.MEMBERID=c.MENTORID";
  $checkLvlResult = mysqli_query($dbconn, $checkLvl);

  $newuserRow = mysqli_fetch_array($newresult);
  $checkLvlRow = mysqli_fetch_array($checkLvlResult);
...
<!--your chat--><div class="chat-history">
    <ul class="m-b-0">
        <?php
...
if($newfiles==null){
     echo '<li class="clearfix">
            ...
            <div class="message other-message float-right">' . $studentID . '</div>
            <div class="message other-message float-right">ATTACHMENT:' . $newfiles . '<a href="download.php?filename=' . urlencode($newfile) . '"><p>Download</p></a></div>
        ...
        $mentorid = $checkLvlRow['MENTORID'];
        $menteeid = $newuserRow['MEMBERID'];
    ...
    if($newfile == null) {
        echo '<li class="clearfix">
            <div class="message-data">
                <span class="message-data-time">From (Mentor): ' . $newname . '</span>
            </div>
            <div class="message-data">
        ...
        echo '<li class="clearfix">
            ...
            echo '<li class="clearfix">
                ...
                <div class="message my-message">' . $newstudentID . '</div>
                 <div class="message my-message">ATTACHMENT:' . $newfile . '<a href="download.php?filename=' . urlencode($newfile) . '">Download</a></div>
