...
if (isset($_SESSION['username'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $updateSql = "UPDATE user SET username = '$newUsername', email = '$newEmail', name = '$newName', age = '$newAge',address = '$newAddress', phone_number = '$newPhoneNumber' WHERE userid = '$userID'";
