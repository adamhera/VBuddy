...
// if user is logged in succesfully,all data from userid will be displayed in indexmentodash.php
    ...
    <aside>
      <div class="profile">
        <div class="top">
          ...
          <div class="info">
            <p><p>Hey, Mentor<br> <b><?php echo displayProfile($userid, 'NAME'); ?></b></p>
        ...
        <div class="about">
          ...
          <h5>DOB</h5>
          <p><?php echo displayProfile($userid, 'NAME'); ?></p>
          <h5>Contact</h5>
          <p><?php echo displayProfile($userid, 'PHONE_NUMBER'); ?></p>
          <h5>Email</h5>
          <p><?php echo displayProfile($userid, 'EMAIL'); ?>m</p>
          <h5>Address</h5>
    ...
    <div class="right">
      <div class="announcements">
        ...
        <div class="updates">
          <div class="message">
            <p>
              <b>Write your announcement</b> <br />
      ...
      <div class="leaves">
        ...
        <div class="teacher">
          ...
          <div class="info">
            <h3>The Professor</h3>
            <small class="text-muted">Leave: 1st June - 10th June</small>
          </div>
        </div>
        ...
        <div class="teacher">
          ...
          <div class="info">
            <h3>Dr. Adams</h3>
            <small class="text-muted">Leave: 5th June - 15th June</small>
          </div>
        </div>
      </div>
    </div>
