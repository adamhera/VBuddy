...
<body>
    <header>
      ...
      <a rel="noopener" href="../Dashboard/index2.php">
        <img src="images/dashboard.png" alt="" />
      </a
            <a href="../Dashboard/index2.php">
    ...
    <div class="edit-profile-container">
        <form method="POST" action="update_profile.php">
            ...
            <div class="box">
				<p>Name: <input type="text" name="name" value="<?php echo $name; ?>" readonly style="background-color: lightgray;"></p>
			</div>
			<div class="box">
				<p>Username: <input type="text" name="username" value="<?php echo $username; ?>"></p>
			</div>
			<div class="box">
				<p>Age: <input type="text" name="age" value="<?php echo $age. " " . "Years Old"; ?>" readonly style="background-color: lightgray; width: 100px;"></p>
            ...
            <div class="button">
                ...
                <a href="../Dashboard/index2.php" class="text-muted">Cancel</a>
            </div>
        </form>
    </div>
</body>
