...
<body>
   ...
   <main>
         ...
         <div class="exam timetable">
          <h2>List of Class/Activites Available</h2>
        ...
        $query = "SELECT a.*,b.MENTORID FROM TOPIC a JOIN assign b JOIN user c 
WHERE a.ASSIGNID = b.ASSIGNID AND b.MENTORID=c.USERID AND c.USERNAME='$username'
...
";
        ...
        ?>
          ...
          <tbody>
              ...
              <td>
                <a href="chat.php?topicid=<?php echo $row['TOPICID']; ?>&userid=<?php echo $row['MENTORID']; ?>&groupid=<?php echo $row['ASSIGNID']; ?>">Enter Chat Room</a>
              </td>
        ...
        <p> <center> *Note: Please click "View discussion" to enter discussion with your mentees.</center></p>
    </main>
