...
function displayProfile2($username, $column)
{
    ...
    $sql = "SELECT a.COURSENAME,d.* FROM course a JOIN assign b ON a.COURSEID = b.COURSEID JOIN mentee c ON b.ASSIGNID = c.ASSIGNID JOIN topic d ON b.ASSIGNID = d.ASSIGNID JOIN user e WHERE e.username = '$username' AND c.ASSIGNID = d.ASSIGNID AND b.MENTORID=e.USERID GROUP BY d.TOPICID ORDER BY d.date ASC";
...
<!-- Navigation button for mentor dashboard -->
<body>
<header>
  ...
  <div class="exam timetable">
    ...
    // Retrieve all topics
	$topicID= displayProfile2($username, 'TOPICID');
